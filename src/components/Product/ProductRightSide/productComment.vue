...
<style scoped lang="less">
    ...
    .productComment /deep/ .el-col-12 {
        width: 900px;
    }
    .productComment /deep/ .el-input__inner {
        margin-top: -3px;
    }
    .productComment /deep/ .el-table .cell, .el-table th div, .el-table--border td:first-child .cell, .el-table--border th:first-child .cell {
        padding-left: 5px;
    }
    .productComment /deep/ .el-table .cell, .el-table th div {
        padding-right: 5px;
    }
    .productComment /deep/ .el-rate__icon {
        margin-right: 2px;
    }
    .productComment /deep/ .el-table .cell {
        white-space: nowrap;
    }
    .common {
