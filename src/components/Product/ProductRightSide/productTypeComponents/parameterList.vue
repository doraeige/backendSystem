        ...
        <common-nav :title="title" :show="show"></common-nav>
         <el-row class="common">
            ...
            <el-table
                ...
                <el-table-column prop="parameter" label="参数名称" width="90"></el-table-column>
                <el-table-column prop="categoryName" label="商品类型" width="90"></el-table-column>
                <el-table-column prop="way" label="参数录入方式" width="120"></el-table-column>
                <el-table-column prop="list" label="可选值列表" width="260"></el-table-column>
                <el-table-column prop="sort" label="排序" width="90"></el-table-column>
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        <span class="scope-text" @click="openAddParameterPage">编辑</span>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            */
            openAddParameterPage(){
                this.$router.push({ name: 'addParameter'})
            },
            /**
            * 删除按钮点击事件
        ...
        mounted() {
            this.axios.get('/parameterlist').then(res => {
...
<style scoped lang="less">
    ...
    .parameterList /deep/ .el-table .cell {
        padding-left: 5px;
        padding-right: 5px;
        text-align: center;
    }
    .parameterList /deep/ .el-pagination .el-select .el-input .el-input__inner {
        margin-top: -3px;
    }
   .common {
